...
Интеллектуальная платформа для анализа дискуссий в Telegram-каналах с использованием 7-фазной архитектуры Map-Resolve-Reduce и гибридной системы реранкинга Medium постов.

## 🚀 Особенности

- **7-фазная Map-Resolve-Reduce архитектура** - эффективная обработка больших объемов сообщений с гибридным реранкингом
...
### 7-фазная архитектура Map-Resolve-Reduce
...
5. **Comment Groups Phase** - GPT-4o-mini находит релевантные дискуссии в комментариях
6. **Comment Synthesis Phase** - Gemini 2.0 Flash извлекает дополнительные инсайты
7. **Response Building** - Формирование финального multi-expert ответа
