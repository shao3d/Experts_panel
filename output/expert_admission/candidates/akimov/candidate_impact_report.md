...
- Passport cells: 2
- Passport: `output/expert_admission/semantic_passports/akimov/output/akimov_semantic_passport.normalized.json`

## Baseline

- Baseline passports: 10
- Baseline experts: 10
- Baseline exact cells: 32
- Baseline domain + intent rollups: 18
