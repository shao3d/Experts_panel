...
- Passport cells: 3
- Passport: `output/expert_admission/semantic_passports/llm_under_hood/output/llm_under_hood_semantic_passport.normalized.json`

## Baseline

- Baseline passports: 11
- Baseline experts: 11
- Baseline exact cells: 33
- Baseline domain + intent rollups: 19
