...
- Passport cells: 4
- Passport: `output/expert_admission/semantic_passports/ai_grabli/output/ai_grabli_semantic_passport.normalized.json`

## Baseline

- Baseline passports: 9
- Baseline experts: 9
- Baseline exact cells: 30
...
| AI Architect | 2 | 1 | 1 | `coding_agents/choose_ai_coding_tool` |
| Polyakov | 1 | 0 | 1 | `coding_agents/choose_ai_coding_tool` |
| Glebkudr | 1 | 0 | 1 | `coding_agents/choose_ai_coding_tool` |
