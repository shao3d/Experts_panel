...
- Passport cells: 6
- Passport: `output/expert_admission/semantic_passports/etechlead/output/etechlead_semantic_passport.normalized.json`

## Baseline

- Baseline passports: 15
- Baseline experts: 15
- Baseline exact cells: 39
...
- Clean gaps outside accepted overlap: 3
...
| `model_landscape/model_comparison/compare_models_for_task` | fills_gap | 5.0 |  |  | human_review_then_possible_accept |
...
| AI Architect | 3 | 1 | 2 | `coding_agents/choose_ai_coding_tool`<br>`coding_agents/design_agentic_dev_workflow` |
