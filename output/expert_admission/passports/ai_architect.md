...
- `ai_architect:282` (2026-04-16, case_study; `coding_agents`, `agent_ops`, `model_landscape`) - **CLI Creator Skill** Тут ребятки из openai вчера релизнули новый curated skill — [CLI Creator](https://github.com/openai/skills/blob/main/skills/.curated/cli-creator/SKILL.md) Skill уже добавлен в Codex App Он позволяет создать cli + skill для вашей рутины из имеющихся: API docs, OpenAPI JSON, SDK docs, curl exampl...
- `ai_architect:281` (2026-04-15, case_study; `coding_agents`, `agent_ops`, `ai_product_pm`) - **Продолжая тему ****skills + cli**i](https://t.me/the_ai_architect/280)**, вот что из недавнего удалось реализовать** На моей основной работе появилась необходимость создать удобную замену cloudflare tunnels (выставить в интернет порт своего локального проекта) с примерно такими тезисами из ТЗ: - каждый разработчик...
