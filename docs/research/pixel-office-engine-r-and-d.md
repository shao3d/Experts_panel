...
- **Структура (Experts Panel)**: 4 комнаты с проходами:
  - Левая: кухня/столовая (FLOOR_4, amber) — обеденный стол, кофемашины, диван
  - Центр-лево: рабочая зона (FLOOR_7, brown) — столы, PC, стулья
  - Центр-право: рабочая зона экспертов (FLOOR_1/9, blue) — 4 рабочих места
  - Правая: библиотека (FLOOR_2, burgundy) — книжные полки, кресла
- **Предметов мебели**: 75
