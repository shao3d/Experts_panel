...
| Agentic read-only поиск по корпусу (Expert Scout) | `docs/guides/expert-scout.md` | `backend/scripts/expert_scout.py`, `.opencode/agents/expert-scout.md`, `scripts/expert_scout.sh` |
